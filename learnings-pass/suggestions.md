...
## 2026-04-10 — Learning Agent Run #65

### S187: Stale branch accumulation — 491 branches (42nd flag, HIGH)
**File:** Multiple repos
**Issue:** 491 stale remote `claude/` branches across all repos, up from 490 at run #64 (+0.2%). The auto-merger creates PRs but never deletes source branches after merge. First flagged S37 (run #15), now 42nd time flagged.
...
**Priority:** HIGH — 42nd time flagged.

### S188: pm-interview-practice still missing CLAUDE.md (35th flag)
**File:** `pm-interview-practice/CLAUDE.md` (does not exist)
**Issue:** Flagged 35 times since S70. Repo has a live deployment, deep closeout posted, and memory documentation but no CLAUDE.md for agent context.
**Suggestion:** Create CLAUDE.md with architecture (Express+WS port 3456, Claude CLI interviewer, browser TTS/STT), deployment (SSH tunnel), key files.
**Priority:** LOW — 35th time flagged, infrequent changes.
