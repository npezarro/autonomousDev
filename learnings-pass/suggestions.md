...
## 2026-04-09 — Learning Agent Run #39

### S116: PAT scope blocking repos — 290 branches (S113 — 18th escalation, CRITICAL)
**File:** GitHub PAT configuration (infrastructure)
**Issue:** S60→...→S113→still unfixed. Unmerged `claude/auto-*` and `claude/learnings-*` branches total **290** across repos (up from 273 at run #38). The fine-grained PAT only covers a subset of repos, so autonomousDev runs push branches but can't create PRs. First flagged run #25, now 18th consecutive run.
**Suggestion:** Switch to a classic PAT with full repo scope, or add all actively-developed repos to the fine-grained PAT. Then bulk-create PRs for pending branches.
**Priority:** CRITICAL — 18th time flagged. Branch count 273→290. No progress on underlying PAT scope issue.

### S117: Stale branch accumulation — 290 branches (S114 — 19th flag, HIGH)
**File:** Multiple repos
**Issue:** 290 stale `claude/auto-*` and `claude/learnings-*` branches. The auto-merger never deletes source branches after merge. PAT-blocked branches accumulate indefinitely. First flagged S37 (run #15), now 19th time flagged.
**Suggestion:** Add post-merge branch deletion to auto-merger. Run periodic cleanup for branches whose content is already on main.
**Priority:** HIGH — 19th time flagged.

### S118: pm-interview-practice still missing CLAUDE.md (S115 — 13th flag)
**File:** `pm-interview-practice/CLAUDE.md` (does not exist)
**Issue:** Flagged 13 times since S70. Repo has a live deployment, deep closeout posted, and memory documentation but no CLAUDE.md for agent context.
**Suggestion:** Create CLAUDE.md with architecture (Express+WS port 3456, Claude CLI interviewer, browser TTS/STT), deployment (SSH tunnel), key files.
**Priority:** LOW — 13th time flagged, infrequent changes.

---

## 2026-04-09 — Learning Agent Run #40

### S119: PAT scope blocking repos — 291 branches (S116 — 19th escalation, CRITICAL)
**File:** GitHub PAT configuration (infrastructure)
**Issue:** S60→...→S116→still unfixed. Unmerged `claude/auto-*` and `claude/learnings-*` branches total **291** across repos (up from 290 at run #39). The fine-grained PAT only covers a subset of repos, so autonomousDev runs push branches but can't create PRs. First flagged run #25, now 19th consecutive run.
**Suggestion:** Switch to a classic PAT with full repo scope, or add all actively-developed repos to the fine-grained PAT. Then bulk-create PRs for pending branches.
**Priority:** CRITICAL — 19th time flagged. Branch count 290→291. No progress on underlying PAT scope issue.

### S120: Stale branch accumulation — 291 branches (S117 — 20th flag, HIGH)
**File:** Multiple repos
**Issue:** 291 stale `claude/auto-*` and `claude/learnings-*` branches. The auto-merger never deletes source branches after merge. PAT-blocked branches accumulate indefinitely. First flagged S37 (run #15), now 20th time flagged.
**Suggestion:** Add post-merge branch deletion to auto-merger. Run periodic cleanup for branches whose content is already on main.
**Priority:** HIGH — 20th time flagged.

### S121: pm-interview-practice still missing CLAUDE.md (S118 — 14th flag)
**File:** `pm-interview-practice/CLAUDE.md` (does not exist)
**Issue:** Flagged 14 times since S70. Repo has a live deployment, deep closeout posted, and memory documentation but no CLAUDE.md for agent context.
**Suggestion:** Create CLAUDE.md with architecture (Express+WS port 3456, Claude CLI interviewer, browser TTS/STT), deployment (SSH tunnel), key files.
**Priority:** LOW — 14th time flagged, infrequent changes.

---

## 2026-04-09 — Learning Agent Run #41

### S122: PAT scope blocking repos — 292 branches (S119 — 20th escalation, CRITICAL)
**File:** GitHub PAT configuration (infrastructure)
**Issue:** S60→...→S119→still unfixed. Unmerged `claude/auto-*` and `claude/learnings-*` branches total **292** across **37 repos** (up from 291 at run #40). The fine-grained PAT only covers a subset of repos, so autonomousDev runs push branches but can't create PRs. First flagged run #25, now 20th consecutive run.
**Suggestion:** Switch to a classic PAT with full repo scope, or add all actively-developed repos to the fine-grained PAT. Then bulk-create PRs for pending branches.
**Priority:** CRITICAL — 20th time flagged. Branch count 291→292. No progress on underlying PAT scope issue.

### S123: Stale branch accumulation — 292 branches across 37 repos (S120 — 21st flag, HIGH)
**File:** Multiple repos (37 affected)
**Issue:** 292 stale `claude/auto-*` and `claude/learnings-*` branches across 37 repos. The auto-merger never deletes source branches after merge. PAT-blocked branches accumulate indefinitely. First flagged S37 (run #15), now 21st time flagged.
**Suggestion:** Add post-merge branch deletion to auto-merger. Run periodic cleanup for branches whose content is already on main.
**Priority:** HIGH — 21st time flagged.

### S124: pm-interview-practice still missing CLAUDE.md (S121 — 15th flag)
**File:** `pm-interview-practice/CLAUDE.md` (does not exist)
**Issue:** Flagged 15 times since S70. Repo has a live deployment, deep closeout posted, and memory documentation but no CLAUDE.md for agent context.
**Suggestion:** Create CLAUDE.md with architecture (Express+WS port 3456, Claude CLI interviewer, browser TTS/STT), deployment (SSH tunnel), key files.
**Priority:** LOW — 15th time flagged, infrequent changes.

---

## 2026-04-09 — Learning Agent Run #43

### S128: PAT scope blocking repos — 294 branches (S125 — 22nd escalation, CRITICAL)
**File:** GitHub PAT configuration (infrastructure)
**Issue:** S60→...→S125→still unfixed. Unmerged `claude/auto-*` and `claude/learnings-*` branches total **294** across repos (up from 293 at run #42). The fine-grained PAT only covers a subset of repos, so autonomousDev runs push branches but can't create PRs. First flagged run #25, now 22nd consecutive run.
**Suggestion:** Switch to a classic PAT with full repo scope, or add all actively-developed repos to the fine-grained PAT. Then bulk-create PRs for pending branches.
**Priority:** CRITICAL — 22nd time flagged. Branch count 293→294. No progress on underlying PAT scope issue.

### S129: Stale branch accumulation — 294 branches (S126 — 23rd flag, HIGH)
**File:** Multiple repos
**Issue:** 294 stale `claude/auto-*` and `claude/learnings-*` branches. The auto-merger never deletes source branches after merge. PAT-blocked branches accumulate indefinitely. First flagged S37 (run #15), now 23rd time flagged.
**Suggestion:** Add post-merge branch deletion to auto-merger. Run periodic cleanup for branches whose content is already on main.
...
## 2026-04-09 — Learning Agent Run #44

### S131: PAT scope blocking repos — 295 branches (S128 — 23rd escalation, CRITICAL)
**File:** GitHub PAT configuration (infrastructure)
**Issue:** S60→...→S128→still unfixed. Unmerged `claude/auto-*` and `claude/learnings-*` branches total **295** across **33 repos** (up from 294 at run #43). The fine-grained PAT only covers a subset of repos, so autonomousDev runs push branches but can't create PRs. First flagged run #25, now 23rd consecutive run.
**Suggestion:** Switch to a classic PAT with full repo scope, or add all actively-developed repos to the fine-grained PAT. Then bulk-create PRs for pending branches.
**Priority:** CRITICAL — 23rd time flagged. Branch count 294→295. No progress on underlying PAT scope issue.

### S132: Stale branch accumulation — 295 branches across 33 repos (S129 — 24th flag, HIGH)
**File:** Multiple repos (33 affected)
**Issue:** 295 stale `claude/auto-*` and `claude/learnings-*` branches across 33 repos. The auto-merger never deletes source branches after merge. PAT-blocked branches accumulate indefinitely. First flagged S37 (run #15), now 24th time flagged.
**Suggestion:** Add post-merge branch deletion to auto-merger. Run periodic cleanup for branches whose content is already on main.
**Priority:** HIGH — 24th time flagged.

### S133: pm-interview-practice still missing CLAUDE.md (S130 — 17th flag)
**File:** `pm-interview-practice/CLAUDE.md` (does not exist)
...
### S134: PAT scope blocking repos — 296 branches (S131 — 24th escalation, CRITICAL)
**File:** GitHub PAT configuration (infrastructure)
**Issue:** S60→...→S131→still unfixed. Unmerged `claude/auto-*` and `claude/learnings-*` branches total **296** across **37 repos** (up from 295 at run #44). The fine-grained PAT only covers a subset of repos, so autonomousDev runs push branches but can't create PRs. First flagged run #25, now 24th consecutive run.
**Suggestion:** Switch to a classic PAT with full repo scope, or add all actively-developed repos to the fine-grained PAT. Then bulk-create PRs for pending branches.
**Priority:** CRITICAL — 24th time flagged. Branch count 295→296. No progress on underlying PAT scope issue.

### S135: Stale branch accumulation — 296 branches across 37 repos (S132 — 25th flag, HIGH)
**File:** Multiple repos (37 affected)
**Issue:** 296 stale `claude/auto-*` and `claude/learnings-*` branches across 37 repos. The auto-merger never deletes source branches after merge. PAT-blocked branches accumulate indefinitely. First flagged S37 (run #15), now 25th time flagged.
**Suggestion:** Add post-merge branch deletion to auto-merger. Run periodic cleanup for branches whose content is already on main.
**Priority:** HIGH — 25th time flagged.
